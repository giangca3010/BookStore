...
class BookCreatFormRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'content'           => 'required|',
//            'fileBook'          => 'required||mimes:pdf|max:25600|exists:books,file',
            'fileBook'          => 'required||mimes:pdf|max:25600|',
            'thumbnail'         => 'required||:jpeg,png,bmp,gif,svg|max:2048|min:25',
        ];
    }
...
//            'fileBook.exists'           => 'File upload lên đã trùng tên với file đã có trên CSDL',
